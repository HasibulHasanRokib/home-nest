...
import { tenantInfoFormSchema } from "@/lib/zod-schema/create-profile-schema";
import {
  AttachmentType,
  Gender,
  HouseholdType,
...
import { tenantInfoAction } from "@/app/profile/create/actions";
...
export function TenantInfoForm() {
  ...
  const form = useForm<z.infer<typeof tenantInfoFormSchema>>({
    resolver: zodResolver(tenantInfoFormSchema),
    defaultValues: {
  ...
  function onSubmit(values: z.infer<typeof tenantInfoFormSchema>) {
    setError("");
    startTransition(async () => {
      const res = await tenantInfoAction(values);
      if (res.error) {
        setError(res.error);
      } else {
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Your family member" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
